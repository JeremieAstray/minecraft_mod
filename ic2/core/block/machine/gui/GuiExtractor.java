...
// Source File Name:   GuiExtractor.java
...
public class GuiExtractor extends GuiContainer
{
	...
	public String name;
	public String inv;
	private static final ResourceLocation background = new ResourceLocation("ic2", "textures/gui/GUIExtractor.png");

	public GuiExtractor(ContainerStandardMachine container)
	{
		super(container);
		this.container = container;
		name = StatCollector.translateToLocal("ic2.blockExtractor");
