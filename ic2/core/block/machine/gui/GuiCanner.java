...
// Source File Name:   GuiCanner.java
...
public class GuiCanner extends GuiContainer
{
	...
	public GuiCanner(ContainerCanner container)
	{
		...
		name = StatCollector.translateToLocal("ic2.blockCanner");
	...
	protected void drawGuiContainerBackgroundLayer(float f, int x, int y)
	{
		...
		if (container.tileEntity.energy > 0)
		{
			...
			drawTexturedModalRect(j + 31, k + 27 + (14 - l), 176, 14 - l, 14, l);
		}
		int i1 = container.tileEntity.gaugeProgressScaled(34);
		drawTexturedModalRect(j + 74, k + 36, 176, 15, i1, 13);
	}
