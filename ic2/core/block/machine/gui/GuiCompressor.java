...
// Source File Name:   GuiCompressor.java
...
public class GuiCompressor extends GuiContainer
{
	...
	public String name;
	public String inv;
	private static final ResourceLocation background = new ResourceLocation("ic2", "textures/gui/GUICompressor.png");

	public GuiCompressor(ContainerStandardMachine container)
	{
		super(container);
		this.container = container;
		name = StatCollector.translateToLocal("ic2.blockCompressor");
