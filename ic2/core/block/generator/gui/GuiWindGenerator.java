...
// Source File Name:   GuiWindGenerator.java
...
public class GuiWindGenerator extends GuiContainer
{
	...
	public GuiWindGenerator(ContainerWindGenerator container)
	{
		...
		name = StatCollector.translateToLocal("ic2.blockWindGenerator");
	...
	protected void drawGuiContainerBackgroundLayer(float f, int x, int y)
	{
		...
		int o = ((TileEntityWindGenerator)container.base).getOverheatScaled(14);
		if (o > 0)
			drawTexturedModalRect(j + 80, (k + 45 + 14) - o, 176, 28 - o, 14, o);
	}
